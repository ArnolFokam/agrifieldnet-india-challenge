...
class AgriFieldDataset(torch.utils.data.Dataset):
    ...
    mean = {
        ...
        'B11': 70.37100837,
        'B12': 48.97029943,
        'NDVI': 2.2422657929344205,
        'NDWI_GREEN': 50.11900778513771,
        'NDWI_BLUE': 28.156099260999262,
    }
    ...
    std = {
        ...
        'NDVI': 5872.113095907767,
        'NDWI_GREEN': 105554.76284980947,
        'NDWI_BLUE': 77750.38547188799,
    }
